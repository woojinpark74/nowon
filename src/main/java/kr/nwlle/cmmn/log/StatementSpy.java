...
public class StatementSpy implements Statement, Spy
{
   ...
   */
  private static final String SQL_WARNING = "{WARNING: Statement used to run SQL} ";
  ...
  protected void reportStatementSql(String sql, String methodCall)
  {
    ...
    _reportSql((DriverSpy.statementUsageWarn?SQL_WARNING:"") +
      sql, methodCall);
  }
  ...
  protected void reportStatementSqlTiming(long execTime, String sql, String methodCall)
  {
    // redirect to one more method call ONLY so that stack trace search is consistent
    // with the reportReturn calls
    _reportSqlTiming(execTime, (DriverSpy.statementUsageWarn?SQL_WARNING:"") +
      sql, methodCall);
  }
  ...
  public void addBatch(String sql) throws SQLException
  {
    ...
    currentBatch.add(DriverSpy.statementUsageWarn?SQL_WARNING:"" + sql);
    try
    {
  ...
  public boolean isWrapperFor(Class<?> iface) throws SQLException
  {
	...
	public void closeOnCompletion() throws SQLException {
		...
		//System.out.println("call StatementSpy closeOnCompletion()");
	}

	@Override
	public boolean isCloseOnCompletion() throws SQLException {
		// TODO Auto-generated method stub
		//System.out.println("call StatementSpy isCloseOnCompletion()");
		return false;
	}
