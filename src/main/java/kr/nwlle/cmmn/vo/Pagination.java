...
import kr.nwlle.cmmn.util.NumberUtil;
...
public class Pagination implements Serializable {
    ...
    private String listType; // 같은 페이지 안에서 두개이상의 페이징 리스트가 필요할경우 각각 페이징 처리 위해 임의 생성

    private String searchTypeCd; // Constant.SEARCH_TYPE_CD참조
     ...
     *            the source List
     * @param sort
     *            the SortDefinition to start with
     */
    ...
    public void setPosition() {
        this.startPosition = ((this.page < 1 ? 1 : this.page) - 1) * this.pageSize;
     ...
     * <p>
     * Calls <code>doSort</code> to trigger actual sorting.
     * 
     * @see #doSort
     */
    public void resort() {
