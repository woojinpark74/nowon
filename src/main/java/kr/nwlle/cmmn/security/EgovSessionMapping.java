package kr.nwlle.cmmn.security;
...
import kr.nwlle.cmmn.vo.LoginVO;
...
public class EgovSessionMapping extends EgovUsersByUsernameMapping {
    ...
    protected EgovUserDetails mapRow(ResultSet rs, int rownum) throws SQLException {
        ...
        String strContentsYn = rs.getString("contentsYn");

        int groupId = Integer.parseInt(rs.getString("group_id")); // 관리 그룹 아이디
        ...
        loginVO.setOrgnztId(""); // 조직아이디
        loginVO.setUniqId(strUniqId);
        /** 2010.06.30 *이용 *조직명 추가 */
        loginVO.setOrgnztNm("");
        loginVO.setGroupId(groupId);
        loginVO.setContentsYn(strContentsYn);
